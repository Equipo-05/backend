    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.GET,    "/api/v1/user/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.GET,    "/api/v2/user/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.POST,   "/api/v1/grants/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.PUT,    "/api/v1/grants/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH,  "/api/v1/grants/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/grants/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v2/grants/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.POST,   "/api/v1/requests/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT,    "/api/v1/requests/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH,  "/api/v1/requests/**").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/requests/**").hasAnyRole("MANAGER", "ADMIN")
